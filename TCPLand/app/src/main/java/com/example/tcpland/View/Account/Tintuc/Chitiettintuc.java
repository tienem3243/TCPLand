...
public class Chitiettintuc extends Fragment {
    FloatingActionButton button;
    Duan news;
    public Chitiettintuc(String dataWeb, Duan news) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview=inflater.inflate(R.layout.chi_tiet_tin_tuc, container, false);
